              ...
              <div className="space-y-2">
                ...
                {progressMessages.filter(msg => msg.rawJson).length === 0 && (
                  <div className="text-gray-500 bg-gray-50 border border-gray-200 italic text-center p-3 rounded">
                    <div className="text-[10px] mb-1">공정 명령이 없습니다</div>
                    <div className="text-[9px]">extwork/extraction/input 토픽으로 JSON 명령을 보내주세요</div>
                  </div>
                )}
                          ...
                          return (
                            <>
                              <circle 
                                ...
                                r="15.9" 
                                fill="none" 
                                stroke={fixedPercent >= 90 ? '#22c55e' : fixedPercent >= 60 ? '#3b82f6' : fixedPercent >= 30 ? '#eab308' : '#6b7280'} 
                                strokeWidth="3" 
                                strokeDasharray={`${fixedPercent}, 100`} 
                                strokeDashoffset="25" 
                                strokeLinecap="round" 
                              ...
                              <text 
                                ...
                                fontSize="10" 
                                fontWeight="bold" 
                                fill={fixedPercent >= 90 ? '#22c55e' : fixedPercent >= 60 ? '#3b82f6' : fixedPercent >= 30 ? '#eab308' : '#6b7280'}
                              >
                                {fixedPercent}%
                              </text>
                            </>
